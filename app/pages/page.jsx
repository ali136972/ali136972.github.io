...
//%%%%%%%%%%  NEXT JS,  از سه بخش تشکیل شده است: 1.Compiler, for interprating javascript code or for Bunddling  or breaking great  javascript code to smaller than of that  2.CLI(Command Line Inerface), for Building my application  3.Nodejs Runtime, for existance javascript in outside of browser via c++ programming %%%%%%%%%%
//%%%%%%%%%%  دو نوع رندر کردن برای اپلیکیشن ها وجود دارد: 1.CSR(Client Side Rendering) 2.SSR(Server Side Rendering) %%%%%%%%%%
//%%%%%%%%%% Search Engine, یکسری crawler, دارد و وقتی که کاربر چیزی را  در داخل مرورگر جستجو می کند در اینصورت crawler, ها با دریافت کلیدواژه های جستجوی کاربر، موضوع را درک کرده و متناسب با موضوع جستجوی کاربر، پیج ها یا صفحات مختلف وبسایت های مختلف که در مورد این موضوع مطالبی را دارند را به کاربر از طرف سروردر پاسخ به درخواست کاربر، ارسال می کنند
  //%%%%%%%%%%  CSR(Client Side Rendering), یعنی وقتی کاربر چیزی را در داخل مرورگر جستجو می کند ، اول یک درخواست به سرور ارسال می شود و تمامی پیج های وبسایت ما از سرور دریافت شده و مقداری محاسبات در پشت صحنه ی مرورگر بر روی نها انجام می شود و ارتباط بین کامپوننت های مختلف صفحات مختلف وبسایت ما به خوبی برقرار است ولی وبسایت هایی که از CSR, استفاده می کنند در SEO(Search Engine Optimazation), خیلی کند عمل می کنند .و Search Engine, این نوع وبسایت ها را بعنوان تبایایای بحساب نمی آورد تا به آن رنکینگ بدهد پس در جستجوی نام این وبسایت ها مثلا در گوگل و ... خیلی دیر بالا می آیند و ناشناخته باقی می مانند%%%%%%%%%%
  ...
  //%%%%%%%%%% Client Component, قسمت بزرگی از وبسایت ما را در سمت سرور، رندر می کند و فقط قسمت کوچکی از این وبسایت را که به کدهای جاواسکریپت نیاز دارد را در سمت کابر یا در داخل مرورگر، Hydration, یا هیدراته می کند
